...
const Contact = () => {
    ...
    const submitHandler = async (event) => {
        ...
        setIsLoading(true)
        try {
            const response = await fetch('https://portfolio-mail-664b.onrender.com/api/portfolio/send-email', {
                method: 'POST',
                headers: {
    ...
    return (
        <div className="container py-12 pb-28">
            <div className="w-full md:w-[90%] lg:w-[80%] xl:w-[60%] mx-auto">
                ...
                <h1 className="title mb-8">If you have any porject or need help. Contact me</h1>
                <div className="">
                    {
                        error && 
                    ...
                    <form onSubmit={submitHandler}>
                        <div className="grid md:grid-cols-2 gap-3">
                            <Input type='text' placeholder='Name' 
                                value={nameValue} error={nameHasError} name='name'
                                onChange={nameChangeHandler} onBlur={nameBlurHandler}
                            />
                            <Input type='email' placeholder='Email' 
                                value={emailValue} error={emailHasError} name='email'
                        ...
                        <Textarea placeholder='Message' 
                            value={messageValue} error={messageHasError} name='message'
                            onChange={messageChangeHandler} onBlur={messageBlurHandler}
                        />
